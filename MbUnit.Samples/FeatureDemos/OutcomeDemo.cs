...
{
    /// <summary>
    /// This test fixture demonstrates how you can cause tests to return different
    /// outcomes.
    /// </summary>
    /// <remarks>
    /// Notice how we use methods like <see cref="Assert.Fail()"/>, <see cref="Assert.Inconclusive()"/>
    /// and <see cref="Assert.Terminate(TestOutcome)"/> to influence the outcome of the test.
    /// </remarks>
    [TestFixture]
